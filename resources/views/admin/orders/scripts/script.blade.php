<input hidden name="getSenderCustomer" value="{{route('admin.order.getSenderCustomer',['id' => ':id'])}}">
<input hidden name="getReceiverCustomer" value="{{route('admin.order.getReceiverCustomer',['id' => ':id'])}}">
<script>
